...
const _hoisted_1 = { class: "fx-radio_box" };
const _hoisted_2 = {
  key: 0,
  class: "fx-radio_text"
};
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock("label", {
    class: ["fx-radio fx-horizontal-hairline", { disabled: _ctx.disabled2 }]
  }, [
    createVNode("input", {
...
script$2.__file = "src/Radio/Radio.vue";

const _Radio = Object.assign(script$2, {
    install: function (app) {
