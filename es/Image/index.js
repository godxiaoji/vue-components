import { defineComponent, openBlock, createBlock, createVNode, computed, resolveDynamicComponent, getCurrentInstance, ref, onMounted, onBeforeUnmount, watch, resolveComponent, createCommentVNode } from 'vue';
...
function loadImageAsync(item, resolve, reject) {
    ...
    if (!item || !item.src) {
        const err = new Exception('src is required', Exception.TYPE.DEFAULT, 'Image');
        return reject(err);
    }
    image.src = item.src;
    ...
    image.onerror = function () {
        reject(new Exception(`src "${item.src}" not found`, Exception.TYPE.DEFAULT, 'Image'));
    };
}
const ListenerQueue = [];
...
function removeComponentFromLazy(uid) {
...
var script$2 = defineComponent({
    ...
    setup(props, { emit }) {
        ...
        function checkInView() {
            ...
            return (top < window.innerHeight * LAZY_PRELOAD &&
                bottom > 0 &&
  ...
  return (openBlock(), createBlock("div", {
    ...
    (_ctx.aspectRatio != null && _ctx.aspectRatio > 0)
      ? (openBlock(), createBlock("span", {
          ...
          style: { 'padding-top': _ctx.aspectRatio * 100 + '%' }
        }, null, 4 /* STYLE */))
      : createCommentVNode("v-if", true),
    (_ctx.loading)
      ? (openBlock(), createBlock("i", _hoisted_1, [
          createVNode(_component_icon, { icon: "ImageOutlined" })
        ]))
      : createCommentVNode("v-if", true),
    (_ctx.error)
      ? (openBlock(), createBlock("i", _hoisted_2, [
          createVNode(_component_icon, { icon: "ImageBreakOutlined" })
        ]))
      : createCommentVNode("v-if", true),
    (_ctx.currentSrc)
      ? (openBlock(), createBlock("img", {
          key: 3,
          class: ["fx-image_img", [_ctx.modeClassName]],
          src: _ctx.currentSrc
...
script$2.__file = "src/Image/Image.vue";

const _Image = Object.assign(script$2, {
    install: function (app) {
