import { defineComponent, openBlock, createBlock, createVNode, computed, resolveDynamicComponent, ref, inject, isRef, onMounted, getCurrentInstance, watch, resolveComponent, renderSlot, createCommentVNode, withDirectives, withModifiers, vShow } from 'vue';
 ...
 * @param object 值
 */
const isStringNumberMix = (object) => {
...
const _Input = Object.assign(script$2, {
    install: function (app) {
