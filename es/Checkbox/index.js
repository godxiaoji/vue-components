import { defineComponent, openBlock, createBlock, createVNode, computed, resolveDynamicComponent, inject, onBeforeUnmount, getCurrentInstance, ref, watch, onMounted, resolveComponent, renderSlot, createCommentVNode } from 'vue';
...
function useCheckboxOrRadio(props, ctx, name) {
    const instance = getCurrentInstance();
    const options = inject(`fx${capitalize(name)}Options`, null);
    const input = ref();
    const { emit } = ctx;
...
const _hoisted_1 = { class: "fx-checkbox_box" };
const _hoisted_2 = {
  key: 0,
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock("label", {
    class: ["fx-checkbox fx-horizontal-hairline", { disabled: _ctx.disabled2 }]
  }, [
    createVNode("input", {
      ...
      ref: "input"
    }, null, 40 /* PROPS, HYDRATE_EVENTS */, ["name", "value", "disabled"]),
...
script$2.__file = "src/Checkbox/Checkbox.vue";

const _Checkbox = Object.assign(script$2, {
    install: function (app) {
