import { defineComponent, openBlock, createBlock, createVNode, computed, resolveDynamicComponent, onMounted, onBeforeUnmount, ref, reactive, watch, resolveComponent, withDirectives, renderSlot, toDisplayString, vShow, createCommentVNode } from 'vue';
 ...
 * @param object 值
 */
function stringMix2StringArray(object) {
...
(function (ScrollState) {
    ScrollState[ScrollState["Center"] = 0] = "Center";
    ScrollState[ScrollState["Upper"] = 1] = "Upper";
    ScrollState[ScrollState["Lower"] = 2] = "Lower";
})(ScrollState || (ScrollState = {}));
var PullRefreshState;
(function (PullRefreshState) {
    PullRefreshState[PullRefreshState["Pulling"] = 0] = "Pulling";
    PullRefreshState[PullRefreshState["Holding"] = 1] = "Holding";
    PullRefreshState[PullRefreshState["Refreshing"] = 2] = "Refreshing";
    ...
    setup(props, ctx) {
        ...
        function onTouchMove(e) {
            ...
            if (!_pullDirection) {
                ...
                if (Math.abs(offsetY) >= Math.abs(offsetX)) {
                    coords.directions = coords.directions.filter(v => {
                        return (inArray(v, ['up', 'down']) &&
                            ((v === 'down' && offsetY > 0) || (v === 'up' && offsetY < 0)));
                    });
                }
                else {
                    coords.directions = coords.directions.filter(v => {
                        return (inArray(v, ['left', 'right']) &&
            ...
            if (distance >= pullRefreshThreshold) {
                ...
                distance =
                    pullRefreshThreshold +
                        Math.ceil((distance - pullRefreshThreshold) /
                            Math.log(Math.abs(distance - pullRefreshThreshold) / 2)); // 除于2比不除更好拉一点
            }
        ...
        function onScroll(e) {
            ...
            // 上下滚动
            if (scrollY) {
                if (scrollTop + clientHeight + lowerThreshold >= scrollHeight &&
                    scrollTop > _prevY) {
                    isToLowerY = true;
                }
...
const _hoisted_1 = { class: "fx-scroll-view_inner" };
      ...
      createVNode("div", {
        ...
        (_ctx.enablePullDirections && _ctx.enablePullDirections.length > 0)
          ? withDirectives((openBlock(), createBlock("div", {
              key: 0,
              class: ["fx-scroll-view_pull-refresh", ['direction--' + (_ctx.pullDirection || 'unknown')]]
            }, [
              renderSlot(_ctx.$slots, "indicator", {
                ...
                createVNode("div", {
                  ...
                  style: _ctx.indicatorStyles
                }, [
                  createVNode(_component_icon, {
                    icon: 
                  _ctx.pullRefreshState === _ctx.PullRefreshState.Refreshing
                    ? 'LoadingOutlined'
                    : 'CircleOutlined'
                ,
                    spin: _ctx.pullRefreshState === _ctx.PullRefreshState.Refreshing
                  }, null, 8 /* PROPS */, ["icon", "spin"]),
                  createVNode("span", null, toDisplayString(_ctx.pullRefreshState === _ctx.PullRefreshState.Refreshing
                  ? '正在刷新'
                  : _ctx.pullRefreshState === _ctx.PullRefreshState.Holding
                  ? '松开刷新'
                  : _ctx.pullDirectionNames[_ctx.pullDirection] + '拉刷新'), 1 /* TEXT */)
                ], 4 /* STYLE */)
              ])
            ], 2 /* CLASS */)), [
              [vShow, !_ctx.lowerLoading]
            ])
...
script$2.__file = "src/ScrollView/ScrollView.vue";

const _ScrollView = Object.assign(script$2, {
    install: function (app) {
