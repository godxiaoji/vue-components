import { defineComponent, openBlock, createBlock, createVNode, computed, resolveDynamicComponent, inject, onBeforeUnmount, getCurrentInstance, resolveComponent, createCommentVNode, renderSlot, createTextVNode, ref, onMounted, reactive, watch, provide, withDirectives, Fragment, renderList, vShow, withModifiers } from 'vue';
...
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_instance_keys__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(43);
...
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(44);
...
var createIteratorConstructor = __webpack_require__(58);
var getPrototypeOf = __webpack_require__(34);
...
__webpack_require__(23);
var entryVirtual = __webpack_require__(42);
...
var arrayMethodUsesToLength = __webpack_require__(85);
...
var map = {
	"./filled/check-circle.svg": 87,
	"./filled/check-square.svg": 88,
	"./filled/close-circle.svg": 89,
	"./filled/heart.svg": 90,
	"./filled/star.svg": 91,
	"./outlined/border.svg": 92,
	"./outlined/check-circle.svg": 93,
	"./outlined/check-square.svg": 94,
	"./outlined/check.svg": 95,
	"./outlined/circle.svg": 96,
	"./outlined/close-circle.svg": 97,
	"./outlined/close.svg": 98,
	"./outlined/delete.svg": 99,
	"./outlined/down-circle.svg": 100,
	"./outlined/down.svg": 101,
	"./outlined/edit.svg": 102,
	"./outlined/exclamation-circle.svg": 103,
	"./outlined/exclamation.svg": 104,
	"./outlined/heart.svg": 105,
	"./outlined/home.svg": 106,
	"./outlined/image-break.svg": 107,
	"./outlined/image.svg": 108,
	"./outlined/info-circle.svg": 109,
	"./outlined/info.svg": 110,
	"./outlined/left.svg": 111,
	"./outlined/loading.svg": 112,
	"./outlined/menu.svg": 113,
	"./outlined/minus.svg": 114,
	"./outlined/plus.svg": 115,
	"./outlined/reload.svg": 116,
	"./outlined/right.svg": 117,
	"./outlined/scan.svg": 118,
	"./outlined/search.svg": 119,
	"./outlined/setting.svg": 120,
	"./outlined/share-alt.svg": 121,
	"./outlined/sound.svg": 122,
	"./outlined/star.svg": 123,
	"./outlined/stop.svg": 124,
	"./outlined/up-circle.svg": 125,
	"./outlined/up.svg": 126,
	"./outlined/user.svg": 127
};
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("svg", null, [
    createVNode("use", { "xlink:href": _ctx.iconName }, null, 8 /* PROPS */, ["xlink:href"])
  ]))
}

script.render = render;
script.__file = "src/Icon/SvgIcon.vue";
...
const createEnumsValidator = (enums) => {
...
function getEnumsValue(enums, value) {
    return inArray(value, enums) ? value : enums[0];
}
/**
 * 判断是否svg组件
 * @param value 值
...
var script$1 = defineComponent({
    ...
    setup(props) {
        ...
        const component = computed(() => {
            return isSvgComponent(props.icon) ? props.icon : script;
        });
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock(resolveDynamicComponent(_ctx.component), {
    class: ["fx-icon", { spin: _ctx.spin }],
    style: _ctx.iconStyles,
    "icon-name": _ctx.iconName
  }, null, 8 /* PROPS */, ["class", "style", "icon-name"]))
}

script$1.render = render$1;
script$1.__file = "src/Icon/Icon.vue";

const _Icon = Object.assign(script$1, {
...
const SIZE_TYPES = ['large', 'middle', 'small'];
const BUTTON_SHAPE_TYPES = ['rectangle', 'round', 'circle', 'square'];
const BUTTON_PATTERN_TYPES = [
    'default',
    'solid',
    'dashed',
    'borderless',
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock("button", {
    class: ["fx-button", [_ctx.classNames, { 'has--icon': _ctx.loading || _ctx.icon, ghost: !!_ctx.ghost }]],
...
script$2.__file = "src/Button/Button.vue";

const _Button = Object.assign(script$2, {
    install: function (app) {
...
const isMobile = /(iPhone|iPod|Android|ios)/i.test(navigator.userAgent) ||
    'ontouchstart' in document.documentElement;
/(iPhone|iPod|ios)/i.test(navigator.userAgent);
...
function getStretchOffset$1(offset) {
    return Math.ceil(offset / Math.log(Math.abs(offset)));
}
const touchEvent = {
    touchstart,
    touchmove,
    touchend,
    getStretchOffset: getStretchOffset$1,
    ...
    getTouch(e) {
        const { pageX, pageY, clientX, clientY } = touchstart === 'touchstart'
            ? e.targetTouches[0] || {
                pageX: 0,
                pageY: 0,
                clientX: 0,
...
const { touchstart: touchstart$1, touchmove: touchmove$1, touchend: touchend$1, addListeners, removeListeners, getTouch } = touchEvent;
function useTouch({ el, onTouchStart, onTouchMove, onTouchEnd }) {
    ...
    onMounted(() => addListeners(el.value, object));
    onBeforeUnmount(() => removeListeners(el.value, object));
    return {};
}
...
var script$3 = defineComponent({
    ...
    setup(props, ctx) {
        ...
        function updateListStyle(transSize, duration = 0) {
            const listStyle = list.value.style;
        ...
        function animateDone(transSize, toIndex, fromIndex) {
            durationTimer = window.setTimeout(() => {
        ...
        useTouch({
            ...
            onTouchEnd(e) {
                ...
                inMove = false;
                if (coords) {
                    const offsetX = direction.value === 'x'
        ...
        watch(() => props.activeIndex, val => swipeTo(val));
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_fx_button = resolveComponent("fx-button");

  return (openBlock(), createBlock("div", {
    class: ["fx-swiper", { vertical: _ctx.direction === 'y' }],
    ...
    withDirectives(createVNode("div", {
      class: ["fx-swiper_indicators", { vertical: _ctx.direction === 'y' }]
    }, [
      (openBlock(true), createBlock(Fragment, null, renderList(_ctx.pagination, (item) => {
        return (openBlock(), createBlock("span", {
          key: item,
          class: ["fx-swiper_indicator", { active: item === _ctx.index }],
          style: {
      ...
      [vShow, _ctx.indicatorDots]
    ]),
    (_ctx.navigationButtons)
      ? withDirectives((openBlock(), createBlock(_component_fx_button, {
          key: 0,
          class: "fx-swiper_prev",
          onClick: _cache[1] || (_cache[1] = withModifiers($event => (_ctx.prev(true)), ["stop"])),
          icon: "LeftOutlined",
          size: "large",
          pattern: "borderless",
          shape: "circle",
          ...
          [vShow, _ctx.pagination.length > 1]
        ])
      : createCommentVNode("v-if", true),
    (_ctx.navigationButtons)
      ? withDirectives((openBlock(), createBlock(_component_fx_button, {
          ...
          onClick: _cache[2] || (_cache[2] = withModifiers($event => (_ctx.next(true)), ["stop"])),
          icon: "RightOutlined",
          size: "large",
          pattern: "borderless",
          shape: "circle",
...
script$3.__file = "src/Swiper/Swiper.vue";

const _Swiper = Object.assign(script$3, {
    install: function (app) {
